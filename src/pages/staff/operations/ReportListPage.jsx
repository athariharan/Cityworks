          ...
          <div className="rp-body">
            ...
            <div className="rp-summary no-print">
              ...
              <div className="rp-summary-chip rp-summary-chip--amber">
                <span className="rp-summary-n">{reports.reduce((s, r) => s + r.logs.length, 0)}</span>
                      ...
                      <div className="rp-timeline">
                        ...
                        <div className="rp-stage">
                          ...
                          <div className="rp-stage-body">
                            ...
                            <div className="rp-stage-grid">
                              <div className="rp-field"><span className="rp-field-lbl">Submitted By</span><span className="rp-field-val rp-highlight">{req?.submittedBy || "—"}</span></div>
                              <div className="rp-field"><span className="rp-field-lbl">Reported At</span><span className="rp-field-val">{fmt(req?.reportedAt)}</span></div>
                        ...
                        <div className="rp-stage">
                          ...
                          <div className="rp-stage-body">
                            ...
                            <div className="rp-stage-grid">
                              <div className="rp-field"><span className="rp-field-lbl">Validated At</span><span className="rp-field-val">{fmt(req?.validatedAt)}</span></div>
                        ...
                        <div className="rp-stage">
                          ...
                          <div className="rp-stage-body">
                            ...
                            <div className="rp-stage-grid">
                              ...
                              <div className="rp-field"><span className="rp-field-lbl">Created At</span><span className="rp-field-val">{fmt(wo.createdAt)}</span></div>
                              <div className="rp-field"><span className="rp-field-lbl">Priority</span><span className="rp-field-val" style={{ color: pc.color, fontWeight: 700 }}>{wo.priority}</span></div>
                              <div className="rp-field"><span className="rp-field-lbl">Scheduled Start</span><span className="rp-field-val">{fmt(wo.scheduledStart)}</span></div>
                              <div className="rp-field"><span className="rp-field-lbl">Scheduled End</span><span className="rp-field-val">{fmt(wo.scheduledEnd)}</span></div>
                              {wo.assignedFieldWorkerIds?.length > 0 && (
                                <div className="rp-field"><span className="rp-field-lbl">Assigned Workers</span>
                                  <span className="rp-field-val">{wo.assignedFieldWorkerIds.map(id => (
                              ...
                              <div className="rp-logs">
                                {logs.map((log, li) => (
                                  <div key={log.logId ?? li} className="rp-log-entry">
                                    ...
                                    <div className="rp-stage-grid">
                                      <div className="rp-field"><span className="rp-field-lbl">Performed By</span><span className="rp-field-val rp-highlight">Worker #{log.performedBy}</span></div>
                                      <div className="rp-field"><span className="rp-field-lbl">Log Status</span><span className="rp-field-val" style={{ color: "#16a34a", fontWeight: 700 }}>{log.status || "—"}</span></div>
                                      <div className="rp-field"><span className="rp-field-lbl">Work Started</span><span className="rp-field-val">{fmt(log.startAt ?? log.start_at)}</span></div>
                                      <div className="rp-field"><span className="rp-field-lbl">Work Ended</span><span className="rp-field-val">{fmt(log.endAt ?? log.end_at)}</span></div>
                                      <div className="rp-field"><span className="rp-field-lbl">Duration</span><span className="rp-field-val">{diffHours(log.startAt ?? log.start_at, log.endAt ?? log.end_at) || "—"}</span></div>
                                    </div>
                                  </div>
                                ))}
                              </div>
                        ...
                        <div className="rp-stage rp-stage--last">
                          ...
                          <div className="rp-stage-body">
                            ...
                            <div className="rp-stage-grid">
                              <div className="rp-field"><span className="rp-field-lbl">Completed On</span><span className="rp-field-val" style={{ fontWeight: 700, color: "#16a34a" }}>{fmt(wo.scheduledEnd)}</span></div>
