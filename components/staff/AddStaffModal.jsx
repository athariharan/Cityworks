...
// Modal form for adding a new staff member — collects personal info, role,
// contact details, and financial/identity data, then POSTs to the staff API.
import { useState } from "react";
import StaffService from "../../services/StaffService";
import "../../styles/AddStaffModal.css";
import { STAFF_ROLES, ROLE_LABELS, SKILLS, BLOOD_GROUPS } from "../../utility/StaffConfig";
...
/** Blocks keys that produce negative / scientific-notation values in money inputs.
 *  Allows '.' so decimal amounts (e.g. 45000.50) can still be typed. */
const blockMoneyKeys = (e) => {
  if (["-", "+", "e", "E"].includes(e.key)) e.preventDefault();
};

// ── Defined OUTSIDE so React never remounts them on re-render ──

function Field({ label, field, type = "text", placeholder = "", required = false,
                 min, step, onKeyDown, form, errors, set }) {
  return (
        ...
        <form onSubmit={handleSubmit}>
          <div className="asm-body">
            ...
            <div className="asm-section">
              ...
              <div className="asm-grid">
                <Select label="Role" field="role" options={STAFF_ROLES} labelMap={ROLE_LABELS} required {...f} />
                {form.role === "CREW" && (
            ...
            <div className="asm-section">
              ...
              <div className="asm-grid">
                <Field label="Salary (₹)"     field="salary"        type="number" placeholder="e.g. 45000"
                       min="0" step="0.01" onKeyDown={blockMoneyKeys} {...f} />
