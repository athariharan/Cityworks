      ...
      <div className="nf-card">
        ...
        <form onSubmit={handleSubmit} noValidate className="nf-form">
            ...
            <>
              <div className="nf-field">
                <input type="text" className="nf-input" placeholder=" "
                  value={name} onChange={(event) => setName(event.target.value)} autoFocus id="nf-name"/>
              ...
              <div className="nf-field">
                <input type="tel" className="nf-input" placeholder=" "
                  value={phone} onChange={(event) => setPhone(event.target.value)} id="nf-phone"/>
          ...
          <div className="nf-field nf-field--password">
            <input type={isShowPassword ? "text" : "password"} className="nf-input" placeholder=" "
              value={password} onChange={(event) => setPassword(event.target.value)} id="nf-password"/>
            <label className="nf-label" htmlFor="nf-password">Password</label>
            <button type="button" className="nf-eye-btn" onClick={() => setIsShowPassword((previousValue) => !previousValue)} tabIndex={-1}>
              <i className={`bi ${isShowPassword ? "bi-eye-slash" : "bi-eye"}`} />
            </button>
          </div>

          <button type="submit" className="nf-submit" disabled={isLoading}>
            {isLoading ? (
